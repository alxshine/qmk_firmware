...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_with_macro( // dvorak
            ...
            KC_A   ,  G(A(KC_S)),  /*   */ KC_A          , KC_LCTL , KC_LGUI , KC_LALT      , LGUI_T(KC_BSPC), KC_SPC, KC_SPC, KC_RALT    , KC_RCTL, _______    , KC_LEFT, KC_DOWN,                             /*   */ KC_RGHT
    ),
	[1] = LAYOUT_65_with_macro( // qwerty
            ...
            KC_MPRV,  KC_MNXT,  /*   */ KC_TAB , KC_Q    , KC_W    , KC_E   , KC_R    , KC_T   , KC_Y   , KC_U   , KC_I   , KC_O   , KC_P   , KC_LBRC, KC_RBRC,              KC_BSLS, /*   */ KC_F3, 
            MO(2)  ,  KC_ESC ,  /*   */ KC_LCTL, KC_A    , KC_S    , KC_D    , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,              KC_ENT , /*   */          KC_F1, 
            KC_CUT ,  KC_COPY,  /*   */ KC_LSFT, KC_Z    , KC_X    , KC_C   , KC_V    , KC_B   , KC_N   , KC_M   , KC_COMM, KC_DOT , KC_SLSH, KC_RSFT,                       KC_UP  , /*   */ KC_F2, 
            _______,  KC_COPY,  /*   */ MO(2)  , KC_LCTL , KC_LGUI , KC_LALT, KC_SPC  , KC_SPC , KC_SPC , KC_RALT, KC_RCTL, _______, KC_LEFT,                                KC_DOWN, /*   */ KC_F4
    ),
	[2] = LAYOUT_65_with_macro( // adjust
            KC_MUTE,  _______,  /*   */ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______ , /*   */ _______, 
            _______,  _______,  /*   */ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,            /*   */ _______  , 
            KC_TRNS,  _______,  /*   */ QK_BOOT, DF(0)  , DF(1)  , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                     /*   */ _______  , 
            ...
            // _______,  _______,  /*   */ _______, _______ , _______ , _______, _______,  _______, _______, _______, A(S(G(KC_C))), A(S(G(KC_R))), _______, _______, _______, _______, /*   */  _______, 
            // _______,  _______,  /*   */ QK_BOOT, TO(0)   , TO(1)   , _______, _______,  _______, _______, KC_MPRV, KC_VOLU                     , KC_VOLD, KC_MNXT, _______, QK_BOOT, /*   */  _______, 
            // _______,  _______,  /*   */ _______, _______ , _______ , _______, _______,  _______, _______, _______, KC_MUTE                     , _______, _______, _______, _______, /*   */  _______, 
            // _______,  _______,  /*   */ KC_TRNS, _______ , _______ , _______, _______,  _______, KC_MPLY, KC_MPLY, _______                     , _______, _______, _______, /*   */  _______
    ),
	...
	// [8] = LAYOUT_65_with_macro( // media and other controls
 //            KC_MUTE,  _______,  /*   */ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, /*   */  KC_HOME, 
 //            _______,  _______,  /*   */ _______, _______, _______, _______, _______, _______, _______, _______, A(S(G(KC_C))), A(S(G(KC_R))), _______, _______, _______,                 _______, /*   */  _______, 
 //            _______,  _______,  /*   */ _______, _______, _______, _______, _______, _______, KC_MPLY, KC_MPRV, KC_VOLU, KC_VOLD, KC_MNXT, _______,                          _______, /*   */  _______, 
 //            _______,  _______,  /*   */ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                          _______, /*   */  _______, 
 //            KC_WH_U,  _______,  /*   */ _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                                   _______, /*   */  _______
 //    )
};
