...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_DVORAK] = LAYOUT_65_with_macro( // dvorak
            ...
            KC_MPRV, KC_MNXT, /* MACRO_LEFT */ KC_TAB        , KC_QUOT , KC_COMM , KC_DOT    , KC_P      , KC_Y ,/*   SPLIT    */ KC_F, KC_G, KC_C   , KC_R      , KC_L   , KC_SLSH   , KC_EQL ,                            /* MACRO_RIGHT */ KC_BSLS, KC_PGUP,
            _______, _______, /* MACRO_LEFT */ LCTL_T(KC_ESC), KC_A    , KC_O    , LT(_ADJUST,KC_E), LT(_ARROWS,KC_U), KC_I  /*   SPLIT    */ , KC_D   , LT(6,KC_H), KC_T   , LT(7,KC_N), KC_S   , KC_MINS,                   /* MACRO_RIGHT */ KC_ENT , KC_PGDN,
	...
	[_QWERTY] = LAYOUT_65_with_macro( // qwerty
            ...
            _______, KC_ESC , /* MACRO_LEFT */ LT(_FUNCS,KC_LCTL) , KC_A    , KC_S    , KC_D      , KC_F      , KC_G                /*   SPLIT    */ , KC_H   , KC_J      , KC_K   , KC_L      , KC_SCLN, KC_QUOT,                   /* MACRO_RIGHT */ KC_ENT , KC_PGDN,
            ...
            _______, KC_COPY, /* MACRO_LEFT */ TO(_ADJUST)         , KC_LCTL , KC_LGUI , KC_LALT   , KC_SPC    , KC_SPC              /*   SPLIT    */ , KC_SPC , KC_RALT   , KC_RCTL, _______   , KC_LEFT,                            /* MACRO_RIGHT */ KC_DOWN, KC_RGHT
    ),
	...
	[_ARROWS] = LAYOUT_65_with_macro( // arrows on right
            KC_MUTE, _______, /* MACRO_LEFT */ _______       , _______ , _______ , _______   , _______   , _______, _______    /*   SPLIT    */ , _______, _______   , _______, _______   , _______, _______, _______,          /* MACRO_RIGHT */ _______, KC_HOME,
	...
	[_FUNCS] = LAYOUT_65_with_macro( // numpad from qwerty (on left)
            KC_MUTE, _______, /* MACRO_LEFT */ _______       , _______ , _______ , _______   , _______   , _______, _______    /*   SPLIT    */ , _______, _______   , _______, _______   , _______, _______, _______,          /* MACRO_RIGHT */ _______, KC_HOME,
