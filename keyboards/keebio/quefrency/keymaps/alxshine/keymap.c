...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_with_macro( // dvorak
            ...
            _______,  KC_PSTE,  /*   */ MO(2)         , KC_LCTL , KC_LGUI , KC_LALT    , LT(4, KC_BSPC), KC_SPC , KC_SPC , KC_RALT    , KC_RCTL, _______    , KC_LEFT, KC_DOWN,                             /*   */ KC_RGHT
    ),
	[1] = LAYOUT_65_with_macro( // qwerty
            KC_MUTE,  KC_MPLY,  /*   */ KC_GRV        , KC_1    , KC_2    , KC_3   , KC_4    , KC_5   , KC_6   , KC_7   , KC_8   , KC_9   , KC_0   , KC_MINS, KC_BSPC, KC_EQL,     KC_DEL , /*   */  KC_HOME, 
            ...
            _______,  KC_COPY,  /*   */ MO(2)         , KC_LCTL , KC_LGUI , KC_LCTL, KC_SPC  , KC_SPC , KC_SPC , KC_RALT, KC_RCTL, _______, KC_LEFT,                                KC_DOWN, /*   */  KC_RGHT
    ),
	[2] = LAYOUT_65_with_macro( // adjust
            ...
            _______,  _______,  /*   */ QK_BOOT         , TO(0)   , TO(1) , _______,_______  , _______, _______, _______, _______, _______, _______, _______,                       _______, /*   */  _______, 
            _______,  _______,  /*   */ _______       , _______ , _______ , _______, _______ , _______, _______, _______, _______, _______, _______, _______,                       _______, /*   */  _______, 
            _______,  _______,  /*   */ KC_TRNS       , _______ , _______ , _______, QK_BOOT , _______, _______, _______, _______, _______, _______,                                _______, /*   */  _______
    ),
	[3] = LAYOUT_65_with_macro( // numpad on right
            ...
            _______,  _______,  /*   */ _______       , KC_LCTL , KC_LCTL , _______, KC_LCTL , _______, _______, KC_4   , KC_5   , KC_6   , KC_PLUS, _______,                       _______, /*   */  _______, 
	...
	[6] = LAYOUT_65_with_macro( // parens, braces, brackets
            KC_MUTE,  _______,  /*   */ _______       , _______ , _______ , _______, _______ , _______, _______, _______, _______, _______, _______, _______, _______, _______,     _______, /*   */  KC_HOME, 
            _______,  _______,  /*   */ _______       , _______ , S(KC_1) , KC_BSLS, S(KC_3) , _______, _______, _______, KC_LSFT, KC_LSFT, KC_LSFT, _______, _______,              _______, /*   */  _______, 
	...
	[7] = LAYOUT_65_with_macro( // F keys on left
            KC_MUTE,  _______,  /*   */ _______       , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,        _______, /*   */  KC_HOME, 
            _______,  _______,  /*   */ _______       , KC_F1  , KC_F2  , KC_F3  , KC_F4  , _______, _______, KC_LSFT, KC_LSFT, _______, KC_LSFT, _______, _______,                 _______, /*   */  _______, 
            _______,  _______,  /*   */ _______       , KC_F5  , KC_F6  , KC_F7  , KC_F8  , _______, _______, KC_LCTL, KC_LCTL, _______, KC_LCTL, _______,                          _______, /*   */  _______, 
            _______,  _______,  /*   */ _______       , KC_F9  , KC_F10 , KC_F11 , KC_F12 , _______, _______, KC_LALT, KC_LALT, _______, KC_LALT, _______,                          _______, /*   */  _______, 
            KC_WH_U,  _______,  /*   */ _______       , _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                                   _______, /*   */  _______
    )
};
