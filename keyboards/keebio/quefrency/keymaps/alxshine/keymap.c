...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_with_macro( // dvorak
            ...
            _______,  G(A(KC_S)),  /*   */ MO(2)         , KC_LCTL , KC_LGUI , KC_LALT      , LGUI_T(KC_BSPC), KC_SPC, KC_SPC, KC_RALT    , KC_RCTL, _______    , KC_LEFT, KC_DOWN,                             /*   */ KC_RGHT
    ),
	[1] = LAYOUT_65_with_macro( // qwerty
            ...
            _______,  KC_ESC ,  /*   */ KC_LCTL, KC_A    , KC_S    , KC_D    , KC_F   , KC_G   , KC_H   , KC_J   , KC_K   , KC_L   , KC_SCLN, KC_QUOT,              KC_ENT , /*   */          KC_F1, 
