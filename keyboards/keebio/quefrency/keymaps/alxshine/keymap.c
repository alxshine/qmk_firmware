...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_with_macro( // dvorak
            ...
            _______, _______, /* MACRO_LEFT */ LCTL_T(KC_ESC), KC_A    , KC_O    , LT(2,KC_E), LT(4,KC_U), KC_I  /*   SPLIT    */ , KC_D   , LT(6,KC_H), KC_T   , LT(7,KC_N), KC_S   , KC_MINS,                   /* MACRO_RIGHT */ KC_ENT , KC_PGDN,
